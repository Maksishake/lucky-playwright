 ...
 * Улучшенный компонент карточки игры
 */
...
export class EnhancedGameCardComponent extends BaseComponent {
  constructor(page: Page, gameCard: Locator) {
    super(page, gameCard, 'Enhanced Game Card');
  }
  ...
  async waitForLoad(): Promise<void> {
    ...
    logger.success('Enhanced game card component loaded');
  }
  ...
  async click(): Promise<void> {
    logger.step('Clicking enhanced game card');
  ...
  async play(): Promise<void> {
    logger.step('Playing enhanced game');
  ...
  async playDemo(): Promise<void> {
    logger.step('Playing enhanced demo');
  ...
  async toggleFavorite(): Promise<void> {
    logger.step('Toggling enhanced favorite');
  ...
  async hover(): Promise<void> {
    logger.step('Hovering over enhanced game card');
   ...
   */
  async getComponentInfo(): Promise<{ name: string; isVisible: boolean; isLoaded: boolean }> {
    return {
